...
var PostFormComponent = React.createClass({
    ...
    render: function() {
           ...
           return (
            ...
            <DefaultLayout name={this.props.name}>
                ...
                <br/><br/><hr/><br/>
                <div className="weather-widget" dangerouslySetInnerHTML={{__html: this.props.meteoval}}></div>
                </div>
...
module.exports = PostFormComponent;